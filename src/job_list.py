...
class JsonJobList(AbstractList):
    """
    Наследуемый класс для добавления вакансий в файл json, а также получения из него вакансий обратно
    """
    def add_vacancy(self, vacancies: list):
        """
    ...
    def del_vacancy(self):
        """
        Метод будет удалять вакансии из файла. Будет дорабатываться после смены логики работы класса.
        :return:
        """
        pass
